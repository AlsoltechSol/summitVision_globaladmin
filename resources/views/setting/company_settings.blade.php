                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                            {{ Form::label('Zoom Account Id', __('Zoom Account Id'), ['class' => 'col-form-label']) }}
                                            {{ Form::text('zoom_account_id', !empty($settings['zoom_account_id']) ? $settings['zoom_account_id'] : '', ['class' => 'form-control', 'placeholder' => 'Zoom Account Id']) }}
                                        </div>
